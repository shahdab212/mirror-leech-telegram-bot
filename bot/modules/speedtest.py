...
from ..helper.ext_utils.bot_utils import cmd_exec, new_task, get_readable_file_size
...
"""
    try:
        ...
        # Fallback to text if photo fails for any reason
        LOGGER.error(str(e))
        await editMessage(speed, string_speed)

# --- END OF FILE mirror-leech-telegram-bot-master/bot/modules/speedtest.py ---
